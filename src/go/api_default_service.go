...
func (s *DefaultAPIService) BannerIdPatch(ctx context.Context, id int32, bannerIdDeleteRequest BannerIdDeleteRequest, token string) (ImplResponse, error) {
...
func (s *DefaultAPIService) BannerPost(ctx context.Context, bannerGetRequest BannerGetRequest, token string) (ImplResponse, error) {
