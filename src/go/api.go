...
type DefaultAPIServicer interface {
	...
	BannerIdPatch(context.Context, int32, BannerIdDeleteRequest, string) (ImplResponse, error)
	BannerPost(context.Context, BannerGetRequest, string) (ImplResponse, error)
